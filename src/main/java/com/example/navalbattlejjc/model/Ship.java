...
public class Ship {
    ...
    /** Method to create a ship in the GridPane based on its length and rotation **/
    ...
    /** Private method to create a specific vessel and add it to the GridPane **/
    ...
    /** Draw a submarine in the graficPane and add it to the shipPane **/
    ...
    /** Draw a destructor in the graficPane and add it to the shipPane **/
    ...
    /** Draw an aircraft carrier in the graficPane and add it to the shipPane **/
...
/** Draw a frigate in the graficPane and add it to the shipPane **/
